...
const styleList = {
  div: 'font-size:14px;line-height:1.8;',
  p: 'font-size:14px;line-height:1.8;',
  h2: 'font-size:18px;line-height:1.8;margin:0.4rem 0;',
  h3: 'font-size:16px;line-height:1.8;margin:0.4rem 0;',
  h4: 'font-size:15px;line-height:1.8;margin:0.3rem 0;',
  pre: 'white-space:pre;background-color:#f8f8f8;line-height:1.2;padding:0.4rem;margin:0.4rem 0;overflow-x:auto;-webkit-overflow-scrolling: touch;',
  code: 'font-family:Menlo,Monaco,Consolas,Courier New,monospace;font-size:10px;padding:.26rem .53em;color:#4e5980;background-color:#f8f8f8;border-radius:2px;line-height:1.2;',
...
export function parser(html) {
  ...
  const parsedHtml = html.replace(reg, ($0, $1) => {
